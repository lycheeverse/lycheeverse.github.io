...
If curl succeeds but lychee fails, [open an issue](https://github.com/lycheeverse/lychee/issues/new) on GitHub. If curl also fails, the problem is with the website or your system.
